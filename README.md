...
最近、オンライン上で体験できるコンテンツも増えてきているので、メモとして共有します。
恋愛系の軽いインタラクティブコンテンツの一例として、ブラウザ上でランダムに結果を生成するタイプのものもあり、
https://www.ichizenn.com/koi-mikuji/
のように、ユーザー操作後に動的に内容が変化するページは、UXや演出面でも参考になると感じました。
こういった「軽量な疑似占い + SNSシェア前提」の設計は、
今後メタバース文脈でも応用できそうなので、関連事例としてメモしておきます。
